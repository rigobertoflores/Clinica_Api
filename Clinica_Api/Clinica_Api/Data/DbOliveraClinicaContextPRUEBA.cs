...
public partial class DbOliveraClinicaContextPRUEBA : DbContext
{
    public DbOliveraClinicaContextPRUEBA()
    {
    }

    public DbOliveraClinicaContextPRUEBA(DbContextOptions<DbOliveraClinicaContextPRUEBA> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<ConfiguracionPrint> ConfiguracionPrintes { get; set; }
